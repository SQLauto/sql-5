...
SELECT 
	...
	t.TABLE_CATALOG,
	t.TABLE_SCHEMA,
	REPLACE(t.TABLE_NAME, 'morAppFma_FMA','') AS TABLE_NAME,
	c.COLUMN_NAME,
	c.ORDINAL_POSITION,
	c.DATA_TYPE,
	...
	n.CONSTRAINT_TYPE,
	k2.TABLE_SCHEMA,
	REPLACE(k2.TABLE_NAME, 'morAppFma_FMA','') AS TABLE_NAME,
	--k2.TABLE_NAME,
	k2.COLUMN_NAME 
FROM 
...
WHERE 
	...
	AND t.TABLE_NAME LIKE 'morAppFma_%'
	AND n.CONSTRAINT_TYPE IN ('PRIMARY KEY','FOREIGN KEY')
ORDER BY
	t.table_NAME
